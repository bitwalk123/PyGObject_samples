...
class MyWindow(Gtk.Window):
    ...
    def __init__(self):
        Gtk.Window.__init__(self, title="セルレンダーコンボ")
        ...
        self.liststore_hardware.append(["テレビ", "Samsung"])
        self.liststore_hardware.append(["スマホ", "LG"])
        self.liststore_hardware.append(["プレーヤー", "Sony"])
        ...
        column_combo = Gtk.TreeViewColumn("コンボ", renderer_combo, text=1)
