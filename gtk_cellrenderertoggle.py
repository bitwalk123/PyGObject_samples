...
class MyWindow(Gtk.Window):
    ...
    def __init__(self):
        Gtk.Window.__init__(self, title="セルレンダートグル")
        ...
        column_toggle = Gtk.TreeViewColumn("トグル", renderer_toggle, active=1)
        ...
        column_radio = Gtk.TreeViewColumn("ラジオ", renderer_radio, active=2)
